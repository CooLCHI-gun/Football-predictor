...
def build_features(
    ...
    typer.echo(build_feature_pipeline(input_path=input_path, output_path=resolved_output))
...
def build_features_full(
    ...
    typer.echo(build_feature_pipeline(input_path=resolved_input, output_path=resolved_output))
...
def download_real_data(
    ...
    build_message = build_feature_pipeline(input_path=summary.normalized_output_path, output_path=resolved_feature_output)
